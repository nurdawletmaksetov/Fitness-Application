...
const Home = ({ setSelectedPage }: Props) => {
    ...
    return (
        <>
            <section
                id="home"
                className="md:flex md:flex-col md:gap-26 bg-gray-20 py-10 md:h-full md:pb-0"
            >
                {/* IMAGE AND MAIN HEADER */}
                <motion.div
                    className="md:flex md:mt-10 mx-auto w-5/6 items-center justify-center md:h-5/7"
                ...
                >
                    ...
                    <motion.div initial="hidden"
                        ...
                        className="flex basis-3/5 justify-center md:ml-40 md:mt-10 md:z-10 md:justify-items-end"
                    >
